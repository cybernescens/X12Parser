  ...
  public class ClaimFormTester
  {
    ...
    public void X12ToClaimModelTest()
    {
      var stream = Assembly.GetExecutingAssembly()
        .GetManifestResourceStream("X12.Hipaa.Tests.Unit.Claims.TestData.ProfessionalClaim1.txt");
    ...
    public void X12ToHcfaPdfTest()
    {
      ...
      var service = new ClaimFormTransformationService(
        new ProfessionalClaimToHcfa1500FormTransformation(
          @"..\..\..\tests\X12.Hipaa.Tests.Unit\Claims\Images\HCFA1500_Red.gif"),
        new InstitutionalClaimToUB04ClaimFormTransformation(
          @"..\..\..\tests\X12.Hipaa.Tests.Unit\Claims\Images\UB04_Red.gif"),
        new ProfessionalClaimToHcfa1500FormTransformation(
          @"..\..\..\tests\X12.Hipaa.Tests.Unit\Claims\Images\HCFA1500_Red.gif")
      );
      ...
      var foXml = service.TransformClaimDocumentToFoXml(document);
      foDocument.LoadXml(foXml);

      #if DEBUG
      var driver = FonetDriver.Make();

      var outputFile = new FileStream("c:\\Temp\\Pdfs\\ProfessionalClaim1.pdf", FileMode.Create, FileAccess.Write);
    ...
    public void X12ToUbPdfLayoutTest()
    {
      var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(
        "X12.Hipaa.Tests.Unit.Claims.TestData.InstitutionalClaim5010.txt");

      var transformation = new InstitutionalClaimToUB04ClaimFormTransformation(
        @"..\..\..\tests\X12.Hipaa.Tests.Unit\Claims\Images\UB04_Red.gif");
      ...
      var outputFile = new FileStream(
        "c:\\Temp\\Pdfs\\InstitutionalClaimPlaceholders.pdf",
        FileMode.Create,
        FileAccess.Write);
    ...
    public void X12ToUbPdfTest()
    {
      ...
      var outputFile = new FileStream("c:\\Temp\\Pdfs\\InstitutionalClaim5010.pdf", FileMode.Create, FileAccess.Write);
      driver.Render(foDocument, outputFile);
      #endif
    }
  }
