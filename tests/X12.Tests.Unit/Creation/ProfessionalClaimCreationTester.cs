...
namespace X12.Tests.Unit.Creation
{
  ...
  public class ProfessionalClaimCreationTester
  {
    ...
    public void Create837_5010Version()
    {
      ...
      var theDate = DateTime.ParseExact("20061003", "yyyyMMdd", null);
      ...
      var theDate2 = DateTime.ParseExact("20061003", "yyyyMMdd", null);
      ...
      var theDate3 = DateTime.ParseExact("20061010", "yyyyMMdd", null);
      ...
      var theDate4 = DateTime.ParseExact("20061010", "yyyyMMdd", null);
      ...
      Assert.AreEqual(
        new StreamReader(Extensions.GetEdi("INS._837P._5010.Example1_HealthInsurance.txt")).ReadToEnd(),
        message.SerializeToX12(true));
