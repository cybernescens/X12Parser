...
namespace X12.Tests.Unit.Unbundling
{
  ...
  public class UnbundlingTester
  {
    ...
    public void UnbundleItemsFrom856Test()
    {
      ...
      var interchange = parser.ParseMultiple(Extensions.GetEdi("ORD._856.Example1.txt")).First();
    ...
    {
      var parser = new X12Parser();
      var interchange = parser.ParseMultiple(Extensions.GetEdi("INS._837P._5010.Example1_2_And_3_Combined.txt"))
        .First();
    ...
    {
      var parser = new X12Parser();
      var interchange = parser.ParseMultiple(Extensions.GetEdi("INS._835._4010.FromNth.835_DeIdent_02.dat")).First();
...
IEA*1*004075123~";
      ...
      var parser = new X12Parser();
      var interchange = parser.ParseMultiple(Extensions.GetEdi("INS._835._4010.Example1_GripElements.txt")).First();
...
IEA*1*004075123~";
    ...
    {
      var parser = new X12Parser();
      var interchange = parser.ParseMultiple(Extensions.GetEdi("INS._837P._4010.FromNth.837_DeIdent_05.dat")).First();
...
IEA*1*000000905~";
      ...
      var parser = new X12Parser();
      var interchange = parser.ParseMultiple(Extensions.GetEdi("INS._837P._4010.Spec_4.1.1_PatientIsSubscriber.txt"))
        .First();
    ...
    private readonly string expectedClaim1 =
...
IEA*1*000000905~";
    ...
    private readonly string expectedClaim2 =
      @"ISA*00*          *01*SECRET    *ZZ*SUBMITTERS.ID  *ZZ*RECEIVERS.ID   *030101*1253*^*00501*000000905*1*T*:~
  GS*HC*SENDER CODE*RECEIVER CODE*19991231*0802*1*X*005010X222~
    ST*837*0021*005010X222~
      BHT*0019*00*244579*20061015*1023*CH~
...
IEA*1*000000905~";
    ...
    private readonly string expectedClaim3 =
      @"ISA*00*          *01*SECRET    *ZZ*SUBMITTERS.ID  *ZZ*RECEIVERS.ID   *030101*1253*^*00501*000000905*1*T*:~
  GS*HC*SENDER CODE*RECEIVER CODE*19991231*0802*1*X*005010X222~
