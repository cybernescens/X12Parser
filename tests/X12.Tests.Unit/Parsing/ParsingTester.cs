  ...
  public class ParsingTester
  {
    private Stream GetEdi(string resourcePath) =>
      Assembly.GetExecutingAssembly()
        .GetManifestResourceStream("X12.Tests.Unit.Parsing._SampleEdiFiles." + resourcePath);
    ...
    {
      var resourcePath = Convert.ToString(TestContext.Properties["ResourcePath"]);
    ...
    {
      var resourcePath =
        Convert.ToString(TestContext.Properties["ResourcePath"]); // "INS._837P._4010.Spec_4.1.1_PatientIsSubscriber.txt";
      ...
      if (!resourcePath.Contains("_0x1D"))
      {
        ...
        var newInterchange = parser.ParseMultiple(x12).First();
    ...
    public void ParseUnicodeFile()
    {
      var fs = Assembly.GetExecutingAssembly().GetManifestResourceStream(
        "X12.Tests.Unit.Parsing._SampleEdiFiles.INS._837P._5010.UnicodeExample.txt");
