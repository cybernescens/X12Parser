...
namespace X12.Tests.Unbundling
{
  [TestFixture]
  public class UnbundlingTester
  {
    ...
    public void UnbundleItemsFrom856Test()
    {
      ...
      var interchange = parser.Parse(Extensions.GetEdi("ORD._856.Example1.txt")).First();
    ...
    {
      var parser = new X12ParserExtension(ParserSettings.Default);
      var interchange = parser.Parse(Extensions.GetEdi("INS._837P._5010.Example1_2_And_3_Combined.txt"))
        .First();
    ...
    {
      var parser = new X12ParserExtension(ParserSettings.Default);
      var interchange = parser.Parse(Extensions.GetEdi("INS._835._4010.FromNth.835_DeIdent_02.dat")).First();
...
IEA*1*004075123~";
      ...
      var parser = new X12ParserExtension(ParserSettings.Default);
      var interchange = parser.Parse(Extensions.GetEdi("INS._835._4010.Example1_GripElements.txt")).First();
...
IEA*1*004075123~";
    ...
    {
      var parser = new X12ParserExtension(ParserSettings.Default);
      var interchange = parser.Parse(Extensions.GetEdi("INS._837P._4010.FromNth.837_DeIdent_05.dat")).First();
...
IEA*1*000000905~";
      ...
      var parser = new X12ParserExtension(ParserSettings.Default);
      var interchange = parser.Parse(Extensions.GetEdi("INS._837P._4010.Spec_4.1.1_PatientIsSubscriber.txt"))
        .First();
