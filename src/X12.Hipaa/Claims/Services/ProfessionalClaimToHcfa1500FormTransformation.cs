...
{
  public class ProfessionalClaimToHcfa1500FormTransformation : ClaimTransformationService,
    IClaimToClaimFormTransfomation
  {
    private readonly string _formImagePath;

    public ProfessionalClaimToHcfa1500FormTransformation(string formImagePath) { _formImagePath = formImagePath; }

    public virtual List<FormPage> TransformClaimToClaimFormFoXml(Claim claim)
    {
      var hcfa = TransformClaimToHcfa1500(claim);
    ...
    public virtual HCFA1500Claim TransformClaimToHcfa1500(Claim claim)
    {
      ...
      {
        hcfa.Field05_PatientsAddress_Street =
      ...
      var patientRelationship = string.Empty;
      ...
      if (otherSubscriber != null)
      {
        ...
        hcfa.Field09c_OtherInsuredsEmployerNameOrSchoolName =
          string.Empty; // XXX: OK to assume org in last name? , Edit: this field should be left blank
      ...
      hcfa.Field10a_PatientConditionRelatedToEmployment = claim.RelatedCauseCode1 == "EM" ||
        claim.RelatedCauseCode2 == "EM" ||
        claim.RelatedCauseCode3 == "EM";

      hcfa.Field10b_PatientConditionRelatedToAutoAccident = claim.RelatedCauseCode1 == "AA" ||
        claim.RelatedCauseCode2 == "AA" ||
        claim.RelatedCauseCode3 == "AA";

      hcfa.Field10c_PatientConditionRelatedToOtherAccident = claim.RelatedCauseCode1 == "AB" ||
        claim.RelatedCauseCode1 == "AP" ||
        claim.RelatedCauseCode1 == "OA" ||
        claim.RelatedCauseCode2 == "AB" ||
        claim.RelatedCauseCode2 == "AP" ||
        claim.RelatedCauseCode2 == "OA" ||
        claim.RelatedCauseCode3 == "AB" ||
        claim.RelatedCauseCode3 == "AP" ||
        claim.RelatedCauseCode3 == "OA";
      ...
      hcfa.Field12_PatientsOrAuthorizedSignature =
        claim.ReleaseOfInformationCode == "Y" ? "Signature on file" : string.Empty;

      hcfa.Field12_PatientsOrAuthorizedSignatureDate = new FormDate();

      hcfa.Field13_InsuredsOrAuthorizedSignature =
        claim.BenefitsAssignmentCertificationIndicator == "Y" ? "Signature on file" : string.Empty;

      var onsetDate = claim.Dates.FirstOrDefault(dr => dr.Qualifier == "431") ??
        claim.Dates.FirstOrDefault(dr => dr.Qualifier == "439");
      ...
      var referringProvider = claim.Providers.FirstOrDefault(
        pr => pr.Name.Type.Identifier == "DN" && pr.Name.Identification.Qualifier == "XX");
    ...
    private void LimitFieldWidths(HCFA1500Claim hcfa)
    {
      ...
      hcfa.Field09d_OtherInsuredsInsurancePlanNameOrProgramName = SetStringLength(
        hcfa.Field09d_OtherInsuredsInsurancePlanNameOrProgramName,
        28);
      ...
      hcfa.Field17_ReferringProviderOrOtherSource_Name =
        SetStringLength(hcfa.Field17_ReferringProviderOrOtherSource_Name, 26);
      ...
      hcfa.Field32b_ServiceFacilityLocation_OtherID =
        SetStringLength(hcfa.Field32b_ServiceFacilityLocation_OtherID, 17);
    ...
    private string ConditionalMarker(bool b) => b ? "X" : "";
    ...
    public virtual List<FormPage> TransformHcfa1500ToFormPages(HCFA1500Claim hcfa)
    {
      ...
      FormPage page = null;
      for (var i = 0; i < hcfa.Field24_ServiceLines.Count; i++)
      {
        if (i % 6 == 0)
        {
          page = new FormPage();
          ...
          AddBlock(
            ...
            35,
            9,
            hcfa.Field20_OutsideLab ? Convert.ToString(hcfa.Field20_OutsideLabCharges) : "",
            TextAlignEnum.right);
        ...
        if (i % 6 == 5 || i == hcfa.Field24_ServiceLines.Count - 1) // Footer
        {
          ...
          {
            if (hcfa.Field27_AcceptAssignment.Value)
          ...
          AddBlock(
            ...
            55,
            9,
            string.Format("{0:0.00}", hcfa.Field28_TotalCharge).Replace(".", " "),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            55,
            9,
            string.Format("{0:0.00}", hcfa.Field29_AmountPaid).Replace(".", " "),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            55,
            9,
            string.Format("{0:0.00}", hcfa.Field30_BalanceDue).Replace(".", " "),
            TextAlignEnum.right);
          ...
          if (hcfa.Field31_PhysicianOrSupplierSignatureIsOnFile.HasValue)
          {
            ...
            if (hcfa.Field31_PhysicianOrSupplierSignatureIsOnFile.Value)
          ...
          AddBlock(
            ...
            string.Format(
              "{0}, {1} {2}",
              hcfa.Field32_ServiceFacilityLocation_City,
              hcfa.Field32_ServiceFacilityLocation_State,
              hcfa.Field32_ServiceFacilityLocation_Zip));
          ...
          AddBlock(
            ...
            string.Format(
              "{0}, {1} {2}",
              hcfa.Field33_BillingProvider_City,
              hcfa.Field33_BillingProvider_State,
              hcfa.Field33_BillingProvider_Zip));
