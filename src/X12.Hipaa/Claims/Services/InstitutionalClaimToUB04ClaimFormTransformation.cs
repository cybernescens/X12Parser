...
namespace X12.Hipaa.Claims.Services
{
  ...
  {
    private readonly string _formImagePath;
    ...
    {
      var ub04 = TransformClaimToUB04(claim);
    ...
    public virtual UB04Claim TransformClaimToUB04(Claim claim)
    {
      ...
      var provider = claim.BillingProvider;
      ...
      if (claim.PayToProvider != null &&
        ...
        claim.PayToProvider.Address != null &&
      ...
      if (claim.OccurrenceSpans != null)
        foreach (var span in claim.OccurrenceSpans)
      ...
      foreach (var line in claim.ServiceLines)
        ub.ServiceLines.Add(
          new UB04ServiceLine {
            ...
            Field45_ServiceDate = line.ServiceDateFrom > DateTime.MinValue
              ? string.Format("{0:MMddyy}", line.ServiceDateFrom)
              : "",
      ...
      var controlNumbers = claim.Identifications
        .Where(id => new[] { "F8", "D9", "9A", "9C", "LX" }.Contains(id.Qualifier)).ToList();
      ...
      var patientReasonDiagnoses =
        claim.Diagnoses.Where(d => d.DiagnosisType == DiagnosisTypeEnum.PatientReason).ToList();
      ...
      if (claim.Notes != null)
      {
        ...
        if (claim.Notes.Count != 0)
        {
          if (claim.Notes.Count == 1)
            ...
            remarksList = GetRemarksLineByLine(
              string.Concat(claim.Notes[0].Description, "   ", claim.Notes[1].Description));
    ...
    private void LimitFieldWidths(UB04Claim ub)
    {
      ...
      foreach (var line in ub.ServiceLines)
    ...
    private List<string> GetRemarksLineByLine(string remark)
    {
      ...
      try
      {
        ...
        {
          var index = remark.LastIndexOf(' ', 27);
          if (index == -1)
          {
            index = 26;
      ...
      switch (subscriber.SubscriberInformation.PayerResponsibilitySequenceNumberCode)
      {
        case "P": {
          if (subscriber.OtherPayer != null)
          {
            ...
            if (!string.IsNullOrEmpty(subscriber.OtherPayer.PriorAuthorizationNumber))
              ub.Field63A_TreatmentAuthorizationCode = SetStringLength(
                subscriber.OtherPayer.PriorAuthorizationNumber,
                34);
          }

          ub.PayerA_Primary.Field52_ReleaseOfInfoCertIndicator = subscriber.ReleaseOfInformationCode;
          ub.PayerA_Primary.Field53_AssignmentOfBenefitsCertIndicator =
            subscriber.BenefitsAssignmentCertificationIndicator;
          ...
          ub.PayerA_Primary.Field62_InsuredsGroupNumber = SetStringLength(
            subscriber.SubscriberInformation.ReferenceIdentification,
            21);
        ...
        case "S": {
          if (subscriber.OtherPayer != null)
          {
            ...
            if (!string.IsNullOrEmpty(subscriber.OtherPayer.PriorAuthorizationNumber))
              ub.Field63B_TreatmentAuthorizationCode = SetStringLength(
                subscriber.OtherPayer.PriorAuthorizationNumber,
                34);
          }

          ub.PayerB_Secondary.Field52_ReleaseOfInfoCertIndicator = subscriber.ReleaseOfInformationCode;
          ub.PayerB_Secondary.Field53_AssignmentOfBenefitsCertIndicator =
            subscriber.BenefitsAssignmentCertificationIndicator;
          ...
          ub.PayerB_Secondary.Field62_InsuredsGroupNumber = SetStringLength(
            subscriber.SubscriberInformation.ReferenceIdentification,
            21);
        ...
        case "T": {
          if (subscriber.OtherPayer != null)
          {
            ...
            if (!string.IsNullOrEmpty(subscriber.OtherPayer.PriorAuthorizationNumber))
              ub.Field63C_TreatmentAuthorizationCode = SetStringLength(
                subscriber.OtherPayer.PriorAuthorizationNumber,
                34);
          }

          ub.PayerC_Tertiary.Field52_ReleaseOfInfoCertIndicator = subscriber.ReleaseOfInformationCode;
          ub.PayerC_Tertiary.Field53_AssignmentOfBenefitsCertIndicator =
            subscriber.BenefitsAssignmentCertificationIndicator;
          ...
          ub.PayerC_Tertiary.Field62_InsuredsGroupNumber = SetStringLength(
            subscriber.SubscriberInformation.ReferenceIdentification,
            21);
    ...
    private void SetCurrentPayer(Claim claim, UB04Claim ub)
    {
      ...
      switch (claim.SubscriberInformation.PayerResponsibilitySequenceNumberCode)
      {
        case "P": {
          ...
          ub.PayerA_Primary.Field62_InsuredsGroupNumber = SetStringLength(
            claim.SubscriberInformation.ReferenceIdentification,
            21);
    ...
    public virtual List<FormPage> TransformUB04ToFormPages(UB04Claim ub04)
    {
      ...
      var pageCount = 1 + (ub04.ServiceLines.Count - 1) / 22;
      FormPage page = null;
      var pageIndex = 0;
      for (var i = 0; i < ub04.ServiceLines.Count; i++)
      {
        if (i % 22 == 0)
        {
          page = new FormPage();
          ...
          AddBlock(
            ...
            13,
            12,
            string.Format("{0:0.00}", ub04.Field39a_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            14,
            12,
            string.Format("{0:0.00}", ub04.Field39b_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            15,
            12,
            string.Format("{0:0.00}", ub04.Field39c_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            16,
            12,
            string.Format("{0:0.00}", ub04.Field39d_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            13,
            12,
            string.Format("{0:0.00}", ub04.Field40a_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            14,
            12,
            string.Format("{0:0.00}", ub04.Field40b_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            15,
            12,
            string.Format("{0:0.00}", ub04.Field40c_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            16,
            12,
            string.Format("{0:0.00}", ub04.Field40d_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            13,
            12,
            string.Format("{0:0.00}", ub04.Field41a_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            14,
            12,
            string.Format("{0:0.00}", ub04.Field41b_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            15,
            12,
            string.Format("{0:0.00}", ub04.Field41c_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            16,
            12,
            string.Format("{0:0.00}", ub04.Field41d_Value.Amount).Replace('.', ' '),
            TextAlignEnum.right);
        }
        ...
        AddBlock(
          ...
          y,
          11,
          string.Format("{0:0.00}", line.Field47_TotalCharges).Replace('.', ' '),
          TextAlignEnum.right);
        ...
        AddBlock(
          ...
          y,
          11,
          string.Format("{0:0.00}", line.Field48_NonCoveredCharges).Replace('.', ' '),
          TextAlignEnum.right);
        ...
        if (i % 22 == 21 || i == ub04.ServiceLines.Count - 1) // Footer
        {
          ...
          if (PerPageTotalChargesView)
          {
            ...
            AddBlock(
              ...
              40,
              11,
              string.Format("{0:0.00}", nonCoveredCharges).Replace('.', ' '),
              TextAlignEnum.right);
          }
          else
          {
            if (pageIndex == pageCount)
            {
              AddBlock(
                ...
                40,
                11,
                string.Format("{0:0.00}", ub04.Field47_Line23_TotalCharges).Replace('.', ' '),
                TextAlignEnum.right);
              ...
              AddBlock(
                ...
                40,
                11,
                string.Format("{0:0.00}", ub04.Field48_Line23_NonCoveredCharges).Replace('.', ' '),
                TextAlignEnum.right);
            }
          }
          ...
          AddBlock(
            ...
            42,
            11,
            string.Format("{0:0.00}", ub04.PayerA_Primary.Field54_PriorPayments).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            43,
            11,
            string.Format("{0:0.00}", ub04.PayerB_Secondary.Field54_PriorPayments).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            44,
            11,
            string.Format("{0:0.00}", ub04.PayerC_Tertiary.Field54_PriorPayments).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            42,
            12,
            string.Format("{0:0.00}", ub04.PayerA_Primary.Field55_EstimatedAmountDue).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            43,
            12,
            string.Format("{0:0.00}", ub04.PayerB_Secondary.Field55_EstimatedAmountDue).Replace('.', ' '),
            TextAlignEnum.right);
          ...
          AddBlock(
            ...
            44,
            12,
            string.Format("{0:0.00}", ub04.PayerC_Tertiary.Field55_EstimatedAmountDue).Replace('.', ' '),
            TextAlignEnum.right);
