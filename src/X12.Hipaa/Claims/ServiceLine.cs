...
namespace X12.Hipaa.Claims
{
  public class ServiceLine
  {
    ...
    {
      get => NonCoveredChargeAmount ?? decimal.Zero;
    ...
    {
      get => NonCoveredChargeAmount.HasValue;
      set { }
    }
    ...
    public Provider PurchasedServiceProvider
    {
      get { return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "QB"); }
    }

    public Provider ServiceFacilityLocation
    {
      get { return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "77"); }
    }

    public Provider SupervisingProvider
    {
      get { return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "DQ"); }
    }

    public Provider OrderingProvider
    {
      get { return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "DK"); }
    }

    public Provider AmbulancePickupLocation
    {
      get { return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "PW"); }
    }

    public Provider AmbulanceDropoffLocation
    {
      get { return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "45"); }
    }

    [XmlElement(ElementName = "OralCavityDesignation")]
    public List<Lookup> OralCavityDesignations { get; set; }
