...
namespace X12.Hipaa.Claims.Forms.Professional
{
  public class HCFA1500Claim
  {
    ...
    public string
      Field04_InsuredsName { get; set; } // HCFA 1500 standard allows 29 total characters for these (3) fields
    ...
    public FormDate
      Field09b_OtherInsuredsDateOfBirth
    {
      get;
      set;
    } // MMDDCCYY - 8 characters, goes to DMG02 (page 151) from X12 spec.
    ...
    public string
      Field12_PatientsOrAuthorizedSignature
    {
      get;
      set;
    } // Signed field.  Store 1 = Signature On File, 2 = Signature NOT On File.  If SOF, enter date in next field

    public FormDate Field12_PatientsOrAuthorizedSignatureDate { get; set; } // MMDDCCYY 

    public string
      Field13_InsuredsOrAuthorizedSignature
    {
      get;
      set;
    } // Signed field.  Store 1 = Signature On File, 2 = Signature NOT On File.  If SOF, enter date in next field
    ...
    public string
      Field17_ReferringProviderOrOtherSource_Name
    {
      get;
      set;
    } // HCFA 1500 standard allows 28 total characters for this field
    ...
    public decimal?
      Field20_OutsideLabCharges
    {
      get;
      set;
    } // 8 digit numeric with implied decimal.  ie '20300' is $203.00.                        // 3-1-4 part diagnosis code.
    ...
    public string
      Field23_PriorAuthorizationNumber { get; set; } // 29 characters                         // Service line details
    ...
    public bool?
      Field27_AcceptAssignment { get; set; } // 1 = Yes, 2 = No.  Refers to acceptance of terms of payor's program.
    ...
    public bool?
      Field31_PhysicianOrSupplierSignatureIsOnFile
    {
      get;
      set;
    } // Signed field.  Store true = Signature On File, false = Signature NOT On File.  If SOF, enter date in next field
    ...
    public string
      Field32_ServiceFacilityLocation_City { get; set; } // 26 characters for this and next two fields combined
